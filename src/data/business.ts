...
export const services = [
  {
    title: "Retail Sales",
    description: "Browse and purchase our latest streetwear collection directly through our social media channels.",
    icon: "shopping-bag",
  },
  {
    title: "Custom Orders",
    description: "Looking for personalized caps or bulk orders? We offer custom designs for events, teams, and businesses.",
    icon: "paintbrush",
  },
  {
    title: "Nationwide Shipping",
    description: "We deliver across the Philippines. Fast and reliable shipping to your doorstep.",
    icon: "truck",
  },
  {
    title: "Wholesale",
    description: "Interested in reselling MicsApparel products? Contact us for wholesale pricing and partnership opportunities.",
    icon: "building-store",
  },
];
