  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-black">
        ...
        {/* Diagonal accent */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-white/[0.02] -rotate-45 translate-x-1/3 -translate-y-1/3" />
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10 w-full pt-20">
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[calc(100vh-160px)]">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 border border-white/10 text-white/60 text-xs tracking-[0.3em] uppercase">
                <span className="w-1.5 h-1.5 bg-white rounded-full animate-pulse" />
                Est. {business.founded} — Tacloban City
              </div>

              <h1 className="font-oswald text-[clamp(4rem,10vw,8rem)] font-bold leading-[0.9] tracking-tight uppercase">
                <span className="block text-white">Mics</span>
                <span className="block text-white">Apparel</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link
                  href="/products"
                  className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-black font-oswald text-sm font-bold tracking-[0.2em] uppercase hover:bg-gray-200 transition-all"
                >
                  Shop Now
                  <svg
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 border border-white/20 text-white font-oswald text-sm font-bold tracking-[0.2em] uppercase hover:bg-white/5 transition-all"
                >
                  Message Us
                </a>
              </div>
              ...
              <div className="flex items-center gap-12 pt-8 border-t border-white/10">
                <div>
                  ...
                  <div className="text-[11px] text-gray-500 tracking-widest uppercase mt-1">
                    Followers
                  </div>
                </div>
                <div>
            ...
            <div className="relative hidden lg:flex items-center justify-center">
              <div className="relative w-[500px] h-[500px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-64 h-64 rounded-full bg-white/[0.03] border border-white/10 flex items-center justify-center">
                    <img
                      src={business.logo}
                      alt="MicsApparel"
                ...
                {/* Floating tags */}
                <div className="absolute top-10 right-0 px-4 py-2 bg-white text-black text-xs font-bold tracking-widest uppercase">
                  New Drop
                </div>
                <div className="absolute bottom-20 left-0 px-4 py-2 border border-white/20 text-white text-xs font-bold tracking-widest uppercase">
                  Premium Quality
                </div>
                <div className="absolute top-1/2 -right-4 px-4 py-2 bg-white text-black text-xs font-bold tracking-widest uppercase">
                  ₱300
                </div>
              </div>
            </div>
      ...
      {/* Marquee */}
      <div className="py-6 border-y border-white/5 overflow-hidden bg-black">
        <div className="flex animate-marquee whitespace-nowrap">
          {[...Array(3)].map((_, i) => (
            <span key={i} className="font-oswald text-6xl font-bold text-white/[0.03] uppercase tracking-wider mx-8">
      ...
      <section className="py-32 bg-black">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="flex items-end justify-between mb-16">
            ...
            <Link
              href="/products"
              className="hidden sm:inline-flex items-center gap-2 text-sm text-gray-400 hover:text-white tracking-widest uppercase transition-colors"
            >
              View All
            ...
            {products.slice(0, 6).map((product) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500">
                  ...
                  <h3 className="font-oswald text-xl font-bold uppercase">{product.name}</h3>
          ...
          <div className="sm:hidden mt-8 text-center">
            <Link
              href="/products"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-black font-oswald text-sm font-bold tracking-widest uppercase"
            >
              View All Products
            </Link>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              ...
              <h2 className="font-oswald text-5xl lg:text-6xl font-bold uppercase tracking-tight leading-[0.95]">
                Born in
                <br />
                Tacloban
              </h2>
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-3 text-sm text-white tracking-widest uppercase group"
              >
            ...
            <div className="relative aspect-square bg-[#111]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black to-transparent">
                <p className="font-oswald text-4xl font-bold uppercase">MicsApparel</p>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-white/5">
            {[
              ...
              <div key={item.num} className="p-10 bg-black group hover:bg-[#0a0a0a] transition-colors">
                <span className="font-oswald text-5xl font-bold text-white/10 group-hover:text-white/20 transition-colors">
                  {item.num}
                </span>
                <h3 className="font-oswald text-2xl font-bold uppercase mt-6 mb-4">
                  {item.title}
                </h3>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid md:grid-cols-3 gap-px bg-white/5">
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="p-10 bg-black">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-white text-black flex items-center justify-center font-oswald font-bold text-xs">
                    {testimonial.name[0]}
                  </div>
                  <div>
                    <p className="text-white text-sm font-medium">{testimonial.name}</p>
                    <p className="text-gray-600 text-xs">{testimonial.source}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-32 bg-white">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 text-center">
          <h2 className="font-oswald text-6xl lg:text-8xl font-bold text-black uppercase tracking-tight mb-8">
            Get Yours
            <br />
            Now
          </h2>
